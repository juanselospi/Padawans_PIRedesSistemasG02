...
void* cliente(void* arg) {
    ...
    while(true) {
        ...
        if(m.tipo == "P/R/") {
            ...
            writeLog("CLIENTE", "SOLICITUD", "P/R/dir");

        } else if (m.tipo == "P/G/") {

            writeLog("CLIENTE", "SOLICITUD", "P/G/" + m.figura + " segmento=" + to_string(m.segmento));
        }
        ...
        while(!respuesta_recibida) {
            ...
            if(!buzon_ci.empty()) {
                ...
                if(respuesta.id == cliente) {
                    ...
                    if(respuesta.tipo == "P/D/") {

                        if (!respuesta.piezas.empty()) {
                            writeLog("CLIENTE", "RESPUESTA", "P/D/" + respuesta.figura + " segmento=" + to_string(respuesta.segmento));
                            ...
                            break;
                        } else if (!respuesta.figuras.empty()) {
                            writeLog("CLIENTE", "RESPUESTA", "P/D/dir");
                    ...
                    } else if(respuesta.tipo == "404") {

                        writeLog("CLIENTE", "RESPUESTA", "404 Not Found");
    ...
    while(!terminado) {
        ...
        if(!buzon_ci.empty()) {
            ...
            if(m.tipo == "P/G/") {
                ...
                writeLog("INTERM", "SOLICITUD", "P/G/" + m.figura + " segmento=" + to_string(m.segmento));
            ...
            if(m.tipo == "P/R/") {
                ...
                cout << "Intermediario procesa solicitud " << m.tipo << " de cliente " << m.id << endl;
                writeLog("INTERM", "SOLICITUD", "P/R/dir");
                writeLog("INTERM", "ENRUTAMIENTO", "Enviando solicitud a servidor");
        ...
        if(!buzon_is.empty()) {
            ...
            if(m.tipo == "P/D/") {
                ...
                if(!m.figuras.empty()) {
                    ...
                    writeLog("INTERM", "RESPUESTA", "P/D/dir");
                    ...
                    writeLog("INTERM", "RESPUESTA", "P/D/" + m.figura + " segmento=" + to_string(m.segmento));
                }
            ...
            if(m.tipo == "404") {
                ...
                writeLog("INTERM", "SOLICITUD", "P/F/" + m.figura + " (reenvío a intermediarios)");
                writeLog("INTERM", "ENRUTAMIENTO", "Reenviando P/F/ (interm-interm)");
        ...
        if(!buzon_i2.empty()) {
            ...
            if(m.tipo == "P/D/") {
                ...
                cout << "Intermediario recibio respuesta " << m.tipo << " de otro intermediario para cliente " << m.id << endl;
                writeLog("INTERM", "RESPUESTA", "404 Not Found figura=" + m.figura + " segmento=" + to_string(m.segmento));
        ...
        if(!buzon_is.empty()) {
            ...
            if(m.tipo == "P/G/" || m.tipo == "P/R/") {
                ...
                if(m.figura.empty()) {
                    ...
                    respuesta.tipo = "404";
                    writeLog("SERVIDOR", "ERROR", "Error procesando solicitud P/G/");
                ...
                if(respuesta.tipo == "P/D/") {
                    ...
                    if(m.tipo == "P/R/") {
                        ...
                        writeLog("SERVIDOR", "RESPUESTA", "P/D/dir");
                    } else {

                        writeLog("SERVIDOR", "RESPUESTA", "P/D/" + m.figura + " segmento=" + to_string(m.segmento));
                    }
                } else if(respuesta.tipo == "404") {
                    
                    writeLog("SERVIDOR", "RESPUESTA", "404 Not Found figura=" + m.figura + " segmento=" + to_string(m.segmento));
                }
